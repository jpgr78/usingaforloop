...
var butadd={path:"add_remove_elements/", element:'button',text: 'should click the Add Element button 5 times'}
var butclick={path:"add_remove_elements/", element:'.example button',text: 'should click the Add Element button 5 times',stop:5,expect:'//div[2]/div/div/div/button'}
